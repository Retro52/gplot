...
- (instancetype)initWithSDLWindow:(SDL_Window *)_window
{
    ...
    self.prevLandscapeOrientation = UIDeviceOrientationLandscapeLeft;
    self.prevPortraitOrientation = UIDeviceOrientationPortrait;

    UIDeviceOrientation orientation = [UIDevice currentDevice].orientation;
    [self onDeviceOrientationDidChangeNotification];

    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(onDeviceOrientationDidChangeNotification) name:UIDeviceOrientationDidChangeNotification object:nil];
...
-(void) onDeviceOrientationDidChangeNotification
{
    UIDeviceOrientation device_orientation = [UIDevice currentDevice].orientation;

    if (UIDeviceOrientationIsLandscape(device_orientation))
      self.prevLandscapeOrientation = device_orientation;

    if (UIDeviceOrientationIsPortrait(device_orientation))
      self.prevPortraitOrientation = device_orientation;
}
